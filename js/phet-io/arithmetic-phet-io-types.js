...
window.phet.phetio.phetioTypes = assert &&
  {
    ...
    "ActionIO.<NumberIO, NumberIO, NumberIO, BooleanIO, StringIO, StringIO>": {
      ...
      "supertype": "ParametricTypeIO.<NumberIO, NumberIO, NumberIO, BooleanIO, StringIO, StringIO>",
    ...
    "FunctionIO.(NumberIO,NumberIO,NumberIO,BooleanIO,StringIO,StringIO)=>VoidIO": {
      ...
      "supertype": "ParametricTypeIO.<NumberIO, NumberIO, NumberIO, BooleanIO, StringIO, StringIO, VoidIO>",
    ...
    "ParametricTypeIO.<NumberIO, NumberIO, NumberIO, BooleanIO, StringIO, StringIO, VoidIO>": {
      "documentation": "A Type that has parameters",
      "events": [],
      "methodOrder": [],
      "methods": {},
      ...
      "supertype": "ObjectIO",
      "typeName": "ParametricTypeIO.<NumberIO, NumberIO, NumberIO, BooleanIO, StringIO, StringIO, VoidIO>"
    },
    "ParametricTypeIO.<NumberIO, NumberIO, NumberIO, BooleanIO, StringIO, StringIO>": {
      "documentation": "A Type that has parameters",
      "events": [],
      "methodOrder": [],
      "methods": {},
      ...
      "supertype": "ObjectIO",
      "typeName": "ParametricTypeIO.<NumberIO, NumberIO, NumberIO, BooleanIO, StringIO, StringIO>"
    },
