...
window.phet.phetio.phetioTypes = assert &&
  {
    ...
    "ActionIO.<NumberIO, NumberIO, NumberIO, BooleanIO, StringIO, StringIO>": {
      ...
      "supertype": "ParametricTypeImplIO.<NumberIO, NumberIO, NumberIO, BooleanIO, StringIO, StringIO>",
    ...
    "EmitterIO.<NumberIO, NumberIO, NumberIO, BooleanIO, StringIO, StringIO>": {
      ...
      "methods": {
        "addListener": {
          "documentation": "Adds a listener which will be called when the emitter emits.",
          "parameterTypes": [
            "FunctionIO.(NumberIO,NumberIO,NumberIO,BooleanIO,StringIO,StringIO)=>VoidIO"
          ],
          "returnType": "VoidIO"
        },
        "emit": {
    ...
    "FunctionIO.(NumberIO,NumberIO,NumberIO,BooleanIO,StringIO,StringIO)=>VoidIO": {
      ...
      "supertype": "ParametricTypeImplIO.<NumberIO, NumberIO, NumberIO, BooleanIO, StringIO, StringIO, VoidIO>",
      "typeName": "FunctionIO.(NumberIO,NumberIO,NumberIO,BooleanIO,StringIO,StringIO)=>VoidIO"
    },
    ...
    "ParametricTypeImplIO.<NumberIO, NumberIO, NumberIO, BooleanIO, StringIO, StringIO, VoidIO>": {
      "documentation": "A Type that has parameters",
      "events": [],
      "methodOrder": [],
      "methods": {},
      ...
      "supertype": "ObjectIO",
      "typeName": "ParametricTypeImplIO.<NumberIO, NumberIO, NumberIO, BooleanIO, StringIO, StringIO, VoidIO>"
    },
    "ParametricTypeImplIO.<NumberIO, NumberIO, NumberIO, BooleanIO, StringIO, StringIO>": {
      "documentation": "A Type that has parameters",
      "events": [],
      "methodOrder": [],
      "methods": {},
      ...
      "supertype": "ObjectIO",
      "typeName": "ParametricTypeImplIO.<NumberIO, NumberIO, NumberIO, BooleanIO, StringIO, StringIO>"
    },
