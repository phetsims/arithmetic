...
(4) Open in the browser: `http://localhost/arithmetic/arithmetic_en.html`
...
(3) Open in the
browser: `http://localhost/arithmetic/build/adapted-from-phet/arithmetic_en_adapted-from-phet.html`
